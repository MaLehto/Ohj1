...
/// @author Matti Lehtoniemi
/// @version 2.2.2019

/// <summary>
/// Peli jossa kerätään pisteitä ohittamalla esteitä
/// </summary>
...
public class painovoimapekka_4 : PhysicsGame
{
    ...
    private readonly Image alkukuva = LoadImage("PekkaAlku");
    private readonly Image kuolemakuva = LoadImage("Pekkahävisit");
    private readonly Image[] juoksu = LoadImages("juoksu1", "juoksu2", "juoksu3", "juoksu4", "juoksu5", "juoksu6", "juoksu7", "juoksu8");
    ...
    public void LuoKentta(PhysicsGame peli, double x, double y)
    {
        LuoMaa(0, 400);
        LuoMaa(0, -400);
        LuoKokoEste();
    ...
    /// <param name="x">x-koordinaatti</param>
    /// <param name="y">y-koordinaatti</param>
    public void LuoMaa(double x, double y)
    {
    ...
    public void LuoEste(double x, double y, string tunniste)
    {
        double leveys = 150;
        ...
        este.Y = y;
        este.Tag = tunniste;
        este.Image = LoadImage ("PekkaEste4");
    ...
    public void LuoKerattava(double x, double y, string tunniste)
    {
    ...
    public void PekkaRajahtaa(PhysicsObject pekka)
    {
    ...
    public void PekkaMenehtyy(PhysicsObject pekka, PhysicsObject este)
    {
        PekkaRajahtaa(pekka);
    }
    ...
    private static void Painovoima(PhysicsObject pekka, Vector painovoima)
    {
    ...
    {
        pisteet = LuoPistelaskuri(Screen.Right - 200.0, Screen.Top - 100.0);
    }
